...
/**
 * Class providing functionality for CollectionUtils.
 *
...
public abstract class CollectionUtils extends org.apache.commons.collections.CollectionUtils {
	...
	public static List<String> stringArrayToLongList(String[] objs) {
	...
	public static boolean containsIgnoreCase(final Iterator<String> iterator, final String element) {
		if (iterator != null) {
			while (iterator.hasNext()) {
				String candidate = iterator.next();
				if (ObjectUtils.nullSafeEquals(candidate, element.toLowerCase()) || ObjectUtils.nullSafeEquals(candidate, element.toUpperCase())) {
					return true;
				}
			}
		}
	...
	public static boolean containsIgnoreCase(final Enumeration<String> enumeration, String element) {
		if (enumeration != null) {
			while (enumeration.hasMoreElements()) {
				String candidate = enumeration.nextElement();
				if (ObjectUtils.nullSafeEquals(candidate, element.toLowerCase()) || ObjectUtils.nullSafeEquals(candidate, element.toUpperCase())) {
					return true;
				}
			}
