...
public abstract class ReflectionUtils {
	...
	public static Method getAccessibleMethod(Object target,String name) {
		Assert.notNull(target, "target must not be null ");
	 ...
	 * 支持多级，如：对象名.对象名.方法
	 */
	public static Object invokeinvokeMethodter(Object obj, String propertyName) {
		Object object = obj;
	...
	public static void invokeSetter(Object obj, String propertyName, Object value) {
		...
		for (int i=0; i<names.length; i++){
			if(i<names.length-1){
				...
				invokeSetterMethod(setterMethodName, object, value );
			}
		}
	}
