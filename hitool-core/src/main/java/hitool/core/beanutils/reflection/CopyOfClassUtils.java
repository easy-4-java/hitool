...
public abstract class CopyOfClassUtils extends org.apache.commons.lang3.ClassUtils{
     ...
     */
    private static final Logger LOG = LoggerFactory.getLogger(CopyOfClassUtils.class);
	...
	public static ClassLoader getDefaultClassLoader() {
		...
		if (cl == null) {
			...
			cl = CopyOfClassUtils.class.getClassLoader();
		}
		return cl;
	}
	...
	public static String getShortNameAsProperty(Class<?> clazz) {
		String shortName = CopyOfClassUtils.getShortName(clazz);
	...
	private static String getQualifiedNameForArray(Class<?> clazz) {
		...
		while (clazz.isArray()) {
			...
			result.append(CopyOfClassUtils.ARRAY_SUFFIX);
		}
		...
		if (method != null && isOverridable(method, targetClass) &&
			...
			try {
				if (Modifier.isPublic(method.getModifiers())) {
					...
					Method specificMethod = ReflectionUtils.getMethod(targetClass, method.getName(), method.getParameterTypes());
