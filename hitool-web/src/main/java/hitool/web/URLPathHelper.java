...
import hitool.core.collections.map.LinkedMultiValueMap;
...
public class URLPathHelper {
	...
	protected static Logger LOG = LoggerFactory.getLogger(URLPathHelper.class);
		...
		if (websphereComplianceFlag == null) {
			...
			try {
				...
				if (LOG.isDebugEnabled()) {
					LOG.debug("Could not introspect WebSphere web container properties: " + ex);
				}
			}
