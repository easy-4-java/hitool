...
/**
 * Implementation of s m3 helper functionality.
 *
...
public class SM3Helper {
	...
	public static final BigInteger IV = new BigInteger(ivHexStr.replaceAll(" ",
			""), 16);
	...
	/*
	 * public static Integer P0(Integer x) throws Exception { return
	 * Integer.valueOf(x.intValue() ^ cycleLeftShift(x, 9).intValue() ^
	 * cycleLeftShift(x, 17).intValue()); }
	 * 
	 * public static Integer P1(Integer x) throws Exception { return
	 * Integer.valueOf(x.intValue() ^ cycleLeftShift(x, 15).intValue() ^
	 * cycleLeftShift(x, 23).intValue()); }
	 * 
	 * public static Integer cycleLeftShift(Integer x, int bits) { int y =
	 * x.intValue(); while (bits > 0) { if (y < 0) { y = y << 1; y = y | 0x1; }
	 * else { y = y << 1; } bits--; } return Integer.valueOf(y); }
	 */
	...
	public static byte[] hash(byte[] source) throws Exception {
		...
		RSAPublicPrivateKeyAnalysis.printByteArray(m1, 16);
	...
	public static void main(String[] args) throws Exception {
		...
		byte[] source = { 97, 98, 99, 100, 97, 98, 99, 100, 97, 98, 99, 100,
		...
		RSAPublicPrivateKeyAnalysis.printByteArray(sm3HashValue, 16);
	}
