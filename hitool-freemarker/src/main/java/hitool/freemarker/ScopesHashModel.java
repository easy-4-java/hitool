...
public class ScopesHashModel extends SimpleHash implements TemplateModel {
    ...
    public ScopesHashModel(ObjectWrapper objectWrapper, ServletContext context, HttpServletRequest request, Map<String,Object> stack) {
        super(objectWrapper);
    ...
    private Object findValueOnStack(final String key) {
        if ("parameters".equals(key)) {
            ...
            Object parametersLocal = stack.get(key);
